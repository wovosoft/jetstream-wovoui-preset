...
class XMLWriterPlus extends \XMLWriter
{
    ...
    /** @var array */
    protected array $nsArray = array();

    /** @var bool */
    protected bool $memory = false;

    /**
     * @param string $prefix
     * @param string $uri
     */
    public function addNS(string $prefix, string $uri)
    {
     ...
     * @param string $prefix
     */
    public function removeNS(string $prefix)
    {
     ...
     * @return bool
     */
    public function hasNSPrefix($prefix): bool
    {
     ...
     * @return bool
     */
    public function hasNSUri($uri): bool
    {
     ...
     * @return array
     */
    public function getNSArray(): array
    {
        return $this->nsArray;
    }
     ...
     * @return string|bool
     */
    public function getNSUriFromPrefix(string $prefix): bool|string
    {
     ...
     */
    public function getNSPrefixFromUri($uri): string|int|bool
    {
     ...
     * using @param string $name
     * @param string|null $content
     * @param array $attributes
     * @return bool
     * @params array $attributes
     * @see XMLWriterPlus::addNS()
     *
     */
     ...
     * @return array
     */
    protected function resolveNamespace(string $prefix, ?string $uri): array
    {
        if (null === $uri) {
