...
import {Button, Feedback, Input} from "@wovosoft/wovoui";
import axios from "axios";
import ConfirmsPassword from "@/Components/Basic/ConfirmsPassword.vue";
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div v-if="confirming" class="mt-4">
                        ...
                        <Feedback :message="confirmationForm.errors.code" class="mt-2"/>
                    </div>
                </div>
            ...
            <div class="mt-5">
                <div v-if="! twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <Button value="primary" type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                            Enable
                        </Button>
                    </ConfirmsPassword>
                </div>
