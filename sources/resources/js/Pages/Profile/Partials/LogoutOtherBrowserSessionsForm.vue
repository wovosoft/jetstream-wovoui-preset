...
import {Button, Feedback, Input, Modal} from "@wovosoft/wovoui";
...
<!--                        </svg>-->
            ...
            <div class="flex items-center mt-5">
                <Button variant="primary" @click="confirmLogout">
            ...
            <Modal v-model="confirmingLogout" @close="closeModal">
                <template #title>
                    Log Out Other Browser Sessions
                </template>
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        ...
                        <Feedback :message="form.errors.password" class="mt-2"/>
                    </div>
                </template>
